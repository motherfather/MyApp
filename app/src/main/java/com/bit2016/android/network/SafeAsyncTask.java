package com.bit2016.android.network;
...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
	// slf4j Logger
	// protected org.slf4j.Logger log = LoggerFactory.getLogger( SafeAsyncTask.class );
    ...
    public static class Task<ResultT> implements Callable<Void> {
    	...
    	// slf4j logger
    	// private org.slf4j.Logger log = LoggerFactory.getLogger( Task.class );
            ...
            postToUiThreadAndWait( new Callable<Object>() {
                public Object call() throws Exception {
                    if( e instanceof InterruptedException || e instanceof InterruptedIOException ) {
                    	...
                    	if( parent.onExceptionListener != null ) {
                    		parent.onExceptionListener.onAsyncTaskException( parent, e );
                    	}
    ...
    public interface OnExceptionListener {
    	public abstract void onAsyncTaskException(Callable<?> callable, final Exception exception);
    }    
}